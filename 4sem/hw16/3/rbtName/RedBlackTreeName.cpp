...
int RedBlackTreeName::read(FILE *inFile)
{
    //deleteRedBlackTreeName(Root);
...
RedBlackTreeNameNode * RedBlackTreeName::search(RedBlackTreeNameNode * reference)
{
...
void RedBlackTreeName::insert(char *Name, int Phone, int Group)
{
...
void RedBlackTreeName::deleteValue(char *Name, int Phone, int Group)
{
    ...
    RedBlackTreeNameNode * found = search(tmp);
    if(found != NILL)
    {
	RedBlackTreeNameNode * buff = binaryDeletion(Root, found);
	//delete buff->Data;
	delete buff;
    }
    else
...
RedBlackTreeNameNode * RedBlackTreeName::binaryDeletion(RedBlackTreeNameNode *root, RedBlackTreeNameNode *found)
{
