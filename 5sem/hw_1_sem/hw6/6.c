...
void linear_insertion_sort(double *, int, double (*cmp)(double, double));
...
void linear_insertion_sort(double *a, int n, double (*cmp)(double, double)){
    int i, j, z;
    double f;
    for(i=1; i<n; i++){
        for(j=0; j<=i; j++)
