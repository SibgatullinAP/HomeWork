...
struct PDE_gas_info {
  PDE_gas_info (double mu, double C, double gamma, int max_timestep, double tilde_rho, double tilde_v) : m_mu (mu), m_C(C), m_gamma(gamma), m_max_timestep(max_timestep), m_tilde_rho(tilde_rho), m_tilde_v(tilde_v) {};
