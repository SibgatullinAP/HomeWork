...
double mass(double* A, int N, int M, double h);
...
double mass0(double* A, int N, int M, double h)
{
	double m=0.;
	for(int i = 0; i<M+1; i++)
          {
...
double* init_H(int N, int M, double* H, int k)
{
	 double h=0.001;
        h= h;
        k = k;
...
double* init_V(int N, int M, double* V, int k)
{
        double h=0.001;
        h= h;
        k = k;
