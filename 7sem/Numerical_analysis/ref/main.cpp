...
double p(double x);
void init_a(int N, int M, std::vector<double> &a);
void init_H(int N, int M, std::vector<double> &H);
void init_V(int N, int M, std::vector<double> &V);
void solve(int N, int M, std::vector<double> &a, std::vector<double> &H, std::vector<double> &V, std::vector<double> &b, double max, double mu, double cur, double h, double t);
int C;
...
void init_a(int M, std::vector<double> &a)
{
...
int main(int argc, char*argv[])
{
    ...
    std::vector<double> H ((N+1)*(M+1));
    std::vector<double> V ((N+1)*(M+1));
    std::vector<double> b (M+1);
    std::vector<double> a (3 *(M+1));
