...
int location_of_insertion(char **, int, char*, int (*)(const char *, const char *));
void bin_insertion_sort(char **, int, int (*)(const char *, const char *));
...
void bin_insertion_sort(char **a, int n, int (*cmp)(const char *, const char *)){
    int i, j, z;
    char * f;
    for(i=1; i<n; i++){
...
int location_of_insertion(char **a, int n, char *x, int (*cmp)(const char *, const char *)){
    int l=0, r=n-1;
