...
int main (int argc, const char * argv [])
{
  ...
  if (avg == nullptr)
    {
      printf ("[ERROR] Not enough memmory for avg array!\n");
      delete [] bus;
      delete [] arr;
      return -2;
    }

  int *ans = new int [thread_quantity];
  if (ans == nullptr)
    {
      printf ("[ERROR] Not enough memmory for avg array!\n");
      delete [] bus;
  ...
  memset (avg, 0, thread_quantity * sizeof (double));
  memset (ans, 0, thread_quantity * sizeof (int));
